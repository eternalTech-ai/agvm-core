...
def _configured_model_capability_targets() -> list[dict[str, str]]:
    ...
    bounded_workflow_model = "gpt-4.1-mini"
    retrieval_model = configured_model("AGVM_RETRIEVAL_MODEL", bounded_workflow_model)
    answer_model = configured_model("AGVM_ANSWER_MODEL", bounded_workflow_model)
    ...
    candidates = [
        ...
        ("grow_semantic", configured_model("AGVM_GROW_SEMANTIC_MODEL", bounded_workflow_model)),
    ]
    return [
