...
def grow_semantic_model() -> str:
    return _model_env_or("AGVM_GROW_SEMANTIC_MODEL", DEFAULT_GROW_SEMANTIC_MODEL)
...
def structured_json(
    *,
    ...
    retry_on_max_output_tokens: bool = True,
    ...
    if incomplete_reason:
        ...
        if (
            ...
            and retry_on_max_output_tokens
            and max_output_tokens is not None
            and int(max_output_tokens) < 12000
        ):
