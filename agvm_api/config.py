...
# Search is a bounded multi-role workflow.  Reasoning-first defaults such as
# gpt-5 can consume an entire stage budget before returning structured output.
# The compact model below is live-certified for the public-core time budgets;
# operators can still opt into larger models explicitly.
DEFAULT_BOUNDED_WORKFLOW_MODEL = "gpt-4.1-mini"
DEFAULT_RETRIEVAL_MODEL = os.getenv("AGVM_RETRIEVAL_MODEL", DEFAULT_BOUNDED_WORKFLOW_MODEL)
DEFAULT_ANSWER_MODEL = os.getenv("AGVM_ANSWER_MODEL", DEFAULT_BOUNDED_WORKFLOW_MODEL)
...
DEFAULT_AI_SPATIAL_MODEL = os.getenv("AGVM_AI_SPATIAL_MODEL", DEFAULT_BOUNDED_WORKFLOW_MODEL)
...
DEFAULT_GROW_SEMANTIC_MODEL = os.getenv("AGVM_GROW_SEMANTIC_MODEL", DEFAULT_BOUNDED_WORKFLOW_MODEL)
