...
DEFAULT_OPENAI_MODEL = os.getenv("AGVM_LLM_MODEL", "gpt-4o-mini")
DEFAULT_COMPILER_MODEL = os.getenv("AGVM_COMPILER_MODEL", DEFAULT_OPENAI_MODEL)
...
DEFAULT_SLEEP_MODEL = os.getenv("AGVM_SLEEP_MODEL", DEFAULT_OPENAI_MODEL)
