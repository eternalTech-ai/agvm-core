...
SEARCH_AI_STAGE_TIMEOUT_SECONDS: dict[str, dict[str, float]] = {
    ...
    "evidence_judge": {"flash": 60.0, "balanced": 60.0, "heavy": 90.0, "forensic": 120.0},
    "master_judge": {"flash": 60.0, "balanced": 60.0, "heavy": 60.0, "forensic": 90.0},
...
def _semantic_stream_projection(
    ...
    *,
    ...
    result_payload = _payload_result(payload)
    client_terminal = bool(
        delivery.get("terminal_for_client")
        or payload.get("terminal_for_client")
        or result_payload.get("terminal_for_client")
        or (terminal and not final_materialization_pending)
    )
    return {
